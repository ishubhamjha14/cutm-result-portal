...
export const DashboardPage: React.FC<DashboardPageProps> = ({ onNavigateTab }) => {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      {/* Header Banner */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 rounded-3xl bg-gradient-to-r from-indigo-50 via-slate-100 to-purple-50 dark:from-indigo-950/60 dark:via-slate-900 dark:to-purple-950/60 border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-xl">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-bold text-xs shadow-lg shadow-indigo-600/25 transition-all cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {statCards.map((card) => {
          ...
          return (
            <div
              key={card.title}
              className="glass-card p-6 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-4 relative overflow-hidden bg-white/90 dark:bg-slate-900/50"
            >
              ...
              <div className="flex items-baseline justify-between">
                ...
                <span className={`text-[11px] font-semibold ${card.textColor} px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800`}>
                  {card.badge}
                </span>
              </div>
            </div>
