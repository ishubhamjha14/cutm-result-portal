...
export const ResultMarksheet: React.FC<ResultMarksheetProps> = ({ data, onBack }) => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-5xl mx-auto">
      ...
      <div className="no-print flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-3 sm:p-4 rounded-2xl bg-white/90 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 shadow-sm backdrop-blur-md">
        <button
          onClick={onBack}
      ...
      <div
        ref={marksheetRef}
        className="print-container bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 p-4 sm:p-6 md:p-10 rounded-2xl sm:rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl dark:shadow-2xl relative overflow-hidden"
      >
        ...
        <div className="mt-6 sm:mt-8 space-y-3">
          ...
          {(() => {
            ...
            return (
              <>
                {/* 1. Desktop & Tablet Full Table (Preserved 100% for desktop >= 768px) */}
                ...
                {/* 2. Dedicated Mobile Subject Cards (< 768px viewports) */}
                      ...
                      >
                        ...
                        <div className="grid grid-cols-4 gap-1.5 pt-1 text-center">
                          ...
                          <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 flex flex-col items-center justify-center">
                            ...
                            <span className={`inline-flex items-center justify-center px-1.5 py-0.5 rounded font-mono font-extrabold text-xs border ${getGradeBadge(sub.grade)}`}>
                              {sub.grade}
                            </span>
                          </div>
